...
`GrassiBoard.Installer` is the branded .NET 8 WPF bootstrapper used for the stable v1.0.1 Windows x64 package. CI embeds the verified portable ZIP as a compressed resource and publishes a self-contained single-file `GrassiBoard-Setup` executable.
