...
1. Enable TESTSIGNING, reboot, and install the v0.6.3 driver using the packaged elevated scripts.
...
8. Uninstall v0.6.3, confirm both endpoints disappear, disable TESTSIGNING, and reboot.
