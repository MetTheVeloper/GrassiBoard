...
1. Enable TESTSIGNING, reboot, and test the v0.6.4 capture-matrix packages in the documented order using their elevated scripts.
...
8. Uninstall the final v0.6.4 diagnostic variant, confirm both endpoints disappear, disable TESTSIGNING, and reboot.
