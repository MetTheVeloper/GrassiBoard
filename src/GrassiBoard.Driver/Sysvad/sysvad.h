...
// Product Id
// GrassiBoard product id: {6061584B-55AD-426B-B790-68EF6DE5C89E}
#define STATIC_PID_SYSVAD\
    0x6061584b, 0x55ad, 0x426b, 0xb7, 0x90, 0x68, 0xef, 0x6d, 0xe5, 0xc8, 0x9e
DEFINE_GUIDSTRUCT("6061584B-55AD-426B-B790-68EF6DE5C89E", PID_SYSVAD);
#define PID_SYSVAD DEFINE_GUIDNAMED(PID_SYSVAD)

// Pool tag used for SYSVAD allocations
#define SYSVAD_POOLTAG               'BGSG'

// Debug module name
#define STR_MODULENAME              "GrassiBoard: "
